...
class App extends Component {
  ...
  vantagem() {
    if (this.state.alcool / this.state.gasolina > 0.7) {
      this.setState ({vantagem: 'Gasolina é mais vantajoso'})
    } else {
      this.setState ({vantagem: 'Alcool é mais vantajoso'})
    }
  }
  ...
  return (
    <View style={styles.container}>
      <Image 
        source={{uri:'https://play-lh.googleusercontent.com/j2kCJdaYztc9wXMy0PvDwBBINAZIAPxhnaHeQ_HqbCK0D8kUHVQS7ZHPMR8TaWUKUEo'}}

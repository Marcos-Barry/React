  ...
  render(){
    return (
      <View style={styles.container}>
        <Image 
        source={{uri:'https://s2.glbimg.com/tBn8AZUVZ2cENS45_nnQhbZfSjg=/smart/e.glbimg.com/og/ed/f/original/2021/01/15/balanca-inteligente-4-modelos-para-acompanhar5.png'}}
